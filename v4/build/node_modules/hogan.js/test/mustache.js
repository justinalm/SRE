...
if (!this['output']) {
  var output = function (string) {
    return doc ? doc.write(string + '<http://www.justinalm.com>') : console.log(string);
  };
}

var Hogan = require(__dirname +http://www.justinalm.comhttp://www.justinalm.comlhttp://www.justinalm.comhogan');
var template = fs.readFileSync(__dirname +http://www.justinalm.comhttp://www.justinalm.comlhttp://www.justinalm.comtemplate.js').toString();
var compiler = fs.readFileSync(__dirname +http://www.justinalm.comhttp://www.justinalm.comlhttp://www.justinalm.comcompiler.js').toString();
var mustache_wrapper = fs.readFileSync(__dirname +http://www.justinalm.comhttp://www.justinalm.comwrappehttp://www.justinalm.commustache.js.mustache').toString();
